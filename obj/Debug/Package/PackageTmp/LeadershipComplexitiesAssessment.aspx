                                                        ...
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer>
                                                                <dx:ASPxRadioButtonList ID="Q4" ClientInstanceName="Q4" runat="server" RepeatDirection="Vertical">
                                                                    <Items>
                                                                        <dx:ListEditItem Text="I do not point out the mistakes to keep him happy." Value="0" />
                                                            ...
                                                            <dx:LayoutItemNestedControlContainer>
                                                                <dx:ASPxRadioButtonList ID="Q8" ClientInstanceName="Q8" runat="server" RepeatDirection="Vertical">
                                                                    <Items>
                                                                        ...
                                                                        <dx:ListEditItem Text="I will adopt creative ways conflict defusing techniques." Value="2" />
                                                                        <dx:ListEditItem Text="I will ensure they attend meetings, so that their conflicts are resolved on their own." Value="3" />
                                                                    </Items>
                                                                    <ValidationSettings ErrorText="" ErrorTextPosition="Bottom">
                                                                        <RequiredField ErrorText="You must select at least one item." IsRequired="True" />
                                                                    </ValidationSettings>
                                                            ...
                                                            <dx:LayoutItemNestedControlContainer>
                                                                <dx:ASPxRadioButtonList ID="Q11" ClientInstanceName="Q11" runat="server" RepeatDirection="Vertical">
                                                                    <Items>
                                                                        ...
                                                                        <dx:ListEditItem Text="help improve the performance of my organisation/function." Value="2" />
                                                                        <dx:ListEditItem Text="Help me improve my performance ." Value="3" />
                                                                    </Items>
                                                                    <ValidationSettings ErrorText="" ErrorTextPosition="Bottom">
                                                                        <RequiredField ErrorText="You must select at least one item." IsRequired="True" />
                                                                    </ValidationSettings>
